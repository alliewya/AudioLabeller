...
urlpatterns = [
    ...
    path('classifiermgmt',views.classifiermgmt,name='classifiermgmt'),
    ...
    path('datasetstats',views.datasetStats, name="datasetstats"),
    path('classifierresults',views.classifierResults, name='classifierresults'),
    path('classifierresults2',views.classifierResults2, name='classifierresults2'),
    ...
    path('api/calculate_dataset_stats', views.calculate_dataset_stats, name="calculate_dataset_stats"),
    ...
    path('api/delete_ct/<id>', views.delete_classifier_result, name="delete_classifier_result"),
